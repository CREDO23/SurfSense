...
/**
 * Gets a time-based greeting with optional personalization
 */
...
/**
 * Welcome screen displayed when chat thread is empty
 * Shows time-based greeting and composer component
 */
