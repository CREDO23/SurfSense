...
from app.schemas.video import VideoInput, openai_strict_schema
from app.services.llm_service import get_video_llm

logger = logging.getLogger(__name__)

_VIDEO_SCHEMA = openai_strict_schema(VideoInput)
...
async def generate_video_script(
    ...
    structured_llm = llm.with_structured_output(_VIDEO_SCHEMA)
    ...
    result = VideoInput.model_validate(raw)
