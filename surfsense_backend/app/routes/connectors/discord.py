"""Discord connector routes and indexing functions."""
...
router = APIRouter(prefix="/discord", tags=["connectors:discord"])
...
async def run_discord_indexing(
    ...
    try:
        ...
        if documents_processed > 0:
            ...
            logger.info(
                f"Discord indexing completed: {documents_processed} documents processed"
            )
        else:
            logger.error(
