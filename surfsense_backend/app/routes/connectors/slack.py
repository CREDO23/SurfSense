"""Slack connector routes and indexing functions."""
...
router = APIRouter(prefix="/slack", tags=["connectors:slack"])
...
async def run_slack_indexing(
    ...
    try:
        ...
        if documents_processed > 0:
            ...
            logger.info(
                f"Slack indexing completed: {documents_processed} documents processed"
            )
        else:
            logger.error(
